...
<section id="content">
    ...
    <a href="#">Services for FCV Growers</a>
    <a href="">Crop Development Activities</a>
					
</div>
                   <!-- <p><span class="navclass"> <a href="index.php" style="color:#FFFFFF" >Home</a></span>  &nbsp; &raquo;&nbsp; 
	 	                   <span class="navclass"><a href="#" style="color:#FFFFFF"> Services for FCV Growers</a></span>  &nbsp; &raquo;&nbsp; 
                           <span class="navclass"><a href="#" style="color:#FFFFFF"> Crop Development Activities</a></span>
                      </p>-->
