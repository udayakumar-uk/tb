...
if ($count > 0)
{
	...
	?>
			...
			{
				if($rows['tfile']!="")
				$link="admin/vacanciesfiles/".$rows['tfile'];
				else
				$link="#";
		  ...
		  ?>
				<tr>
				  ...
				  <?php
					...
					{
				  ?>
				  &#8226;	<a href="<?php echo $link?>" <?php if($link!="#"){?>target="_blank"<?php }?>><?php echo $rows['description']; if($fcheck[1]=='pdf'){?>&nbsp;<img src="tob2_imgs/pdf_icon.gif" width="12" height="15" border="0" /><?php }?></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo $link?>" target="<?php if($link!="#"){?>_blank<?php }?>"><img src="tob2_imgs/newindow_icon.gif" border="0" />											
						</a>
				   <?php
				   	}
					else
