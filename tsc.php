...
$selcont=executework("select * from tob_cms where pageid=21");
...
<section id="content">
   ...
   <a href="#">Tobacco Varieties</a>
	<a href="#">Cured Kentucky and Beedi</a>
					
	
</div>
                    <!--<p><span class="navclass"> <a href="index.php" style="color:#FFFFFF" >Home</a></span>  &nbsp; &raquo;&nbsp; 
	 	                   <span class="navclass"><a href="#" style="color:#FFFFFF"> Tobacco Varieties</a></span>  &nbsp; &raquo;&nbsp; 
                           <span class="navclass"><a href="#" style="color:#FFFFFF"> Cured Kentucky and Beedi </a></span>
                      </p>-->
