				  ...
				  ?>
                        ...
                        <br />
                          <div class="example-content">
                            ...
                            <div id="chart2" style="margin-top:20px; margin-left:20px; width:900px; height:550px;" align="center"></div></div></td>
...
<script type="text/javascript" src="jqplot1/plugins/jqplot.categoryAxisRenderer.js"></script>
	<script type="text/javascript" src="jqplot1/plugins/jqplot.dateAxisRenderer.js"></script>
...
//	alert("tot="+prca);
    ...
    { 
      ...
      series:[ 
        ...
        <div><h3 style="text-align:center; font-weight:bold">Region Wise Graph</h3></div>
        <?php
		$i=0;
...
//			echo $stat."  --  ".$catg."  --  ".$gdate;
		...
		?>
        	<div class="col-lg-12">
            <div style="text-align:center; font-weight:700; color:#330099"><h4 style="text-align:center; font-weight:bold"><?php echo $catg; ?></h4></div>
            <div id="subchart<?php echo $i+1; ?>" style="margin-top:20px; margin-left:20px; width:<?php echo $wid; ?>; height:<?php echo $hgt; ?>" align="center">
            </div></div>
            <script>
			$(document).ready(function(){
				if(document.actn.tp[0].checked)
