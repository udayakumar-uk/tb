    ...
    <a href="#">Privacy Policy</a></div>
                  <!--<p><span class="navclass"> <a href="index.php" style="color:#FFFFFF" >Home</a></span>  &nbsp; &raquo;&nbsp; 
					...
					<div class="content" style="padding-top:15px; text-align:justify">
						  ...
						  <p><strong>Note: </strong>The use of the  term “Personal Information” in this privacy statement refersto  any information from which your identity is apparent or can be reasonably  ascertained. </p>
					    <p style="font-size:13px;">&nbsp;</p>
                    </div>
				<!--	<div class="footer">
