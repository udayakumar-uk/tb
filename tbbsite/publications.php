...
<section id="content">
	...
	<a href="#">Publications</a>
                   ...
                   <!-- <p><span class="navclass"> <a href="index.php" style="color:#FFFFFF" >Home</a></span>  &nbsp; &raquo;&nbsp; 
                           ...
                           <span class="navclass"><a href="#" style="color:#FFFFFF"> Publications</a></span>
                      </p>-->
...
if ($count > 0)
{
	...
	?>
		  	...
		  	while($rows=@mysqli_fetch_array($select1))
			{
				...
				{
		  ?>
                <li style="padding-bottom:10px; padding-right:10px;"><a href="<?php echo $link?>" target="<?php if($link!="#"){?>_blank<?php }?>"><?php echo $rows['description']; ?></a>
                </li>
              <?php
			  	}
				else
