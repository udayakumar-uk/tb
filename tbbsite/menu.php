<ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="dropdown-submenu"><a href="#" tabindex="-1">Board&nbsp;Act&nbsp;&&nbsp;Rules</a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown-submenu"><a href="#" tabindex="-1">Employees Corner</a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown-submenu"><a href="#" tabindex="-1">Others</a>
                <ul class="dropdown-menu">
		...
		<li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">Tobacco Varities <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li class="dropdown-submenu"><a href="#" tabindex="-1">FCV Tobacco</a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown-submenu"><a href="#" tabindex="-1">Non FCV Tobacco</a>
                <ul class="dropdown-menu">
                    <li class="dropdown-submenu"><a href="#" tabindex="-1">Burley</a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown-submenu"><a href="#" tabindex="-1">Sun&nbsp;Cured</a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown-submenu"><a href="#" tabindex="-1">Cigar</a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown-submenu"><a href="#" tabindex="-1">Chewing&nbsp;Tobacco</a>
                        <ul class="dropdown-menu">
		...
		<li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">Crop Planning & Regulation <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li> <a href="propolicy.php">Production Policy</a></li>
            <li class="dropdown-submenu"><a href="#" tabindex="-1">Criteria&nbsp;for&nbsp;Registration</a>
                <ul class="dropdown-menu">
        ...
        <li class="dropdown">
         	<a class="dropdown-toggle" data-toggle="dropdown" href="#">Services To FCV Growers<span class="caret"></span></a>
            <ul class="dropdown-menu">
		...
		<li class="dropdown">
         	<a class="dropdown-toggle" data-toggle="dropdown" href="#">Auction System<span class="caret"></span></a>
            <ul class="dropdown-menu">
            	<li class="dropdown-submenu"><a href="#" tabindex="-1">Indroduction</a>
                    <ul class="dropdown-menu">
                ...
                <li class="dropdown-submenu"><a href="#" tabindex="-1">Auction&nbsp;Platform&nbsp;Locations</a>
                    <ul class="dropdown-menu">
        ...
        <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Assistance To Exporterts<span class="caret"></span></a>
            <ul class="dropdown-menu">
                <li><a href="export_per.php">Export Performance</a></li>
                <li><a href="exporters.php">Assistance to Exporters </a></li>
                <li class="dropdown-submenu"><a href="#" tabindex="-1">Export Promotion Activities </a>
                    <ul class="dropdown-menu">
                          <li><a href="indentives.php">Incentives/Benefits</a></li>
                    </ul>
                </li>
                <li class="dropdown-submenu"><a href="#" tabindex="-1">Traders Facilitation </a>
                     <ul class="dropdown-menu">
