		...
		<section class="col-1-3" style="width:40%">
			<!--	<h2 style="border-bottom:2px solid #c66f2f">CIRCULARS & NOTIFICATIONS</h2>-->
				<div class="content" style="padding-top:1px; text-align:justify">
						...
						<p style="font-size:13px;"><strong>Mission:</strong> "To strive for the overall development of tobacco growers and the Indian Tobacco Industry."<br><br>

                       <strong> Vision</strong>
						"Tobacco Board is committed to accomplishing its role - the expressed will of parliament - for the smooth functioning of a vibrant farming system, fair and remunerative prices to tobacco growers and export promotion." </p>
					</div>
