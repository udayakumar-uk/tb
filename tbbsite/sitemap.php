                              ...
                              <td height="30" align="justify"><div class="rightcorner1">
                                <div class="innercontent">
                                  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td valign="top"><p>Home</p>
                                            <p>About us</p>
                                          <ul>
                                              <li>Board Activities</li>
                                            <li>Board Act &amp; Rules</li>
                                            <li>Board Members</li>
                                          ...
                                          <ul>
                                              <li>Flue Cured Virniga (FCV)</li>
                                            <li>Burley &amp; Oriental</li>
                                            <li>Cured Kentucky and Beedi</li>
                                            <li>Cigar Varieties</li>
                                            <li>chewing Tobacco</li>
                                          </ul>
                                          <p>FCV Tobacco</p>
                                          <ul>
                                              <li>FCV(Traditaional)</li>
                                            <li>FCV (NLS)</li>
                                            <li>FCV(SLS)</li>
                                            <li>FCV(Mysore)</li>
                                            <li>Soil types &amp; Characteristics </li>
                                          </ul>
                                          <p>Services For FCV Growers</p>
                                          <ul>
                                              <li>Supply Of Inputs</li>
                                            <li>Services To FCV Farmers</li>
                                            <li>Crop Development Activities</li>
                                            <li>Welfare Schemes </li>
                                          </ul></td>
                                        <td valign="top"><p>E Auction</p>
                                            <p>Export Performance</p>
                                          <p>Crop Planning &amp; Regulation</p>
                                          <ul>
                                              <li>Production Policy</li>
                                            <li>Criteria for Registration </li>
                                            <li>License as FCV Tobacco Grower</li>
                                            <li>License as Barn Operator</li>
                                            <li>License as Construction of barn</li>
                                            <li>For Commecial Nursery Grower</li>
                                            <li>FCV Crop Production Regulatioons </li>
                                          </ul>
                                          <p>Exporters</p>
                                          <ul>
                                              <li>Directory</li>
                                            <li>Assistance to Exporters </li>
                                          </ul>
                                          <p>Contact US</p>
                                          <p>Traders Registration</p>
                                          <p>Cigarette Manufacturers</p>
                                          <p>Auction Platforms</p>
                                          <p>News &amp; Events</p>
                                          <p>Photogallery</p>
                                          <p>Circulars &amp; Notifications</p>
                                          <p>RTI Act</p>
                                          <p>Tenders </p>
                                          <p>&nbsp; </p></td>
                                      </tr>
