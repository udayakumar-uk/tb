namespace eval ::rss-synd {
	...
	set rss(antara) {
		...
		"output"		"8,1\[7,1\@@channel!title@@\8,1]\15,1\ @@item!pubDate@@\4,1\ @@item!title@@\15,1 @@item!description@@\14,1 Selengkapnya (\037@@item!guid@@\037\) "
		"trigger"		"!liputan6"
		"evaluate-tcl"	1
	}

	set rss(detikinet) {
		"url"			"http://detikinet.com/index.php/detik.feed"
		"channels"		"#GembelZ"
		"output"		"8,1\[7,1\@@channel!title@@\8,1]\15,1\ @@item!pubDate@@\4,1\ @@item!title@@\15,1 @@item!description@@\14,1 Selengkapnya (\037@@item!link@@\037)\ "
		"database"		"./scripts/detikinet.db"
		"trigger"		"!detikinet"
		"evaluate-tcl"	1
	}
	set rss(metro) {
		"url"			"http://www.kompas.com/getrss/all"
		"channels"		"#GembelZ"
		"output"		"8,1\[7,1\@@channel!title@@\8,1]\15,1\ @@item!pubDate@@\4,1\ @@item!title@@\15,1 @@item!description@@\14,1 Selengkapnya (\037@@item!link@@\037)\ "
		"database"		"./scripts/kompas.db"
		"trigger"		"!kompas"
		"evaluate-tcl"	1
	}

	set rss(techno) {
		"url"			"http://sindikasi.okezone.com/index.php/techno/RSS2.0"
		"channels"		"#GembelZ"
		"output"		"8,1\[7,1\@@channel!title@@\8,1]\15,1\ @@item!pubDate@@\4,1\ @@item!title@@\15,1 @@item!description@@\14,1 Selengkapnya (\037@@item!link@@\037)\ "
		"database"		"./scripts/techho.db"
		"trigger"		"!techno"
		"evaluate-tcl"	1
	}

	set rss(sport) {
		"url"			"http://sindikasi.okezone.com/index.php/sports/RSS2.0"
		"channels"		"#GembelZ"
		"output"		"8,1\[7,1\@@channel!title@@\8,1]\15,1\ @@item!pubDate@@\4,1\ @@item!title@@\15,1 @@item!description@@\14,1 Selengkapnya (\037@@item!link@@\037)\ "
		"database"		"./scripts/sport.db"
		"trigger"		"!sports"
		"output-order"	1
		"evaluate-tcl"	1
	}
	...
	set rss(bola) {
		"url"			"http://sindikasi.okezone.com/index.php/bola/RSS2.0"
		"channels"		"#GembelZ"
		"output"		"8,1\[7,1\@@channel!title@@\8,1]\15,1\ @@item!pubDate@@\4,1\ @@item!title@@\15,1 @@item!description@@\14,1 Selengkapnya (\037@@item!link@@\037)\ "
		"database"		"./scripts/bola.db"
		"trigger"		"!bola"
		"evaluate-tcl"	1
	}
	
	set rss(kampus) {
		"url"			"http://sindikasi.okezone.com/index.php/kampus/RSS2.0"
		"channels"		"#GembelZ"
		"output"		"8,1\[7,1\@@channel!title@@\8,1]\15,1\ @@item!pubDate@@\4,1\ @@item!title@@\15,1 @@item!description@@\14,1 Selengkapnya (\037@@item!link@@\037)\ "
		"database"		"./scripts/kampus.db"
		"trigger"		"!kampus"
		"evaluate-tcl"	1
	}

	set rss(artis) {
		"url"			"http://sindikasi.okezone.com/index.php/celebrity/RSS2.0"
		"channels"		"#GembelZ"
		"output"		"8,1\[7,1\@@channel!title@@\8,1]\15,1\ @@item!pubDate@@\4,1\ @@item!title@@\15,1 @@item!description@@\14,1 Selengkapnya (\037@@item!link@@\037)\ "
		"database"		"./scripts/artis.db"
		"trigger"		"!artis"
		"evaluate-tcl"	1
	}

	set rss(FB) {
		"url"			"http://www.facebook.com/feeds/notifications.php?id=1710352834&viewer=1710352834&key=AWgvEIV36wOKYViE&format=rss20"
		"channels"		"#GembelZ"
		"output"		"8,1\[7,1\@@channel!title@@\8,1]\15,1\ @@item!pubDate@@\4,1\ @@item!title@@\15,1 @@item!description@@"
		"database"		"./scripts/FB.db"
		"trigger"		"!FB"
		"evaluate-tcl"	1
	}
