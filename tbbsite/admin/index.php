...
$selectp=executework("select * from tob_album_title,tob_images where tob_album_title.id=tob_images.titleid and tob_images.cover=1 order by tob_album_title.position desc,tob_images.position desc limit 8");
	...
	<div class="zerogrid">
		...
		<section class="col-1-3" style="width:33%">
			...
			<section class="col-1-3" style="width:26%; margin-top:-40px;">
				...
				<div class="content">
				  ...
				  {
				  ?>
				<a href="viewphoto.php?tit=<?php  echo $rowp['title'] ?>"><img src="http://tobaccoboard.com/tbdata/photogallery/thimages/<?php  echo $rowp['image'] ?>" height="136" width="auto"></a>
                   <?php 
				  }
				  ?>    
			...
			<div class="zerogrid">
		<div class="row">
			<section class="col-lg-4" style="width:25%; height:400px;">
				<h2 style="border-bottom:2px solid #c66f2f; margin-top:0px;"><span style="border-bottom:2px solid #c66f2f;margin-top:0px;">WHATS NEW</span>S</h2>
				<div class="content">
						<div class="holder">
                          <ul id="ticker01">
                          <?php 
     ...
     <?php }  }?>
	  ...
	  <section class="col-lg-4" style="width:25%">
				<h2 style="border-bottom:2px solid #c66f2f;margin-top:0px;"><span style="border-bottom:2px solid #c66f2f; margin-top:0px;">AUCTION PRICE</span></h2>
	  <div class="content">
						<ul>
          <?php 
