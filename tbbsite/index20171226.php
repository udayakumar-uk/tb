...
<section id="content">
	<div class="zerogrid">
		...
		<section class="col-1-3" style="width:40%">
			...
			<section class="col-1-3" style="width:26%">
				<!--<h2 style="border-bottom:2px solid #c66f2f">WHATS NEW</h2>-->
				<div class="content">
						<p>Coming Soon.....</p>
					</div>
...
?>
	...
	{ $pi++;?>
		<td width="50%"><a href="viewphotos.php?tit=<?php echo $row_imgs['id']; ?>"><img src="https://tobaccoboard.com/admin/photogallery/oimages/<?php echo $row_imgs['image']; ?>" style="width:80%; height:80%"/></a></td>		<?php  if(  ($pi%2)==0) {  ?>
					</tr>
                    <tr>
                      <?php  }
	} }  ?>		</table>
