...
$selcont=executework("select * from tob_cms where pageid=71");
...
<section id="content">
	...
	<a href="#">Services To FCV Farmers</a>
                    ...
                    <!--<p><span class="navclass"> <a href="index.php" style="color:#FFFFFF" >Home</a></span>  &nbsp; &raquo;&nbsp; 
                           ...
                           <span class="navclass"><a href="#" style="color:#FFFFFF"> Services To FCV Farmers</a></span>
                      </p>-->
