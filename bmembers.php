...
<section id="content">
    ...
    <a href="">Board Members</a>
                    ...
                    <!--<p><span class="navclass"> <a href="index.php" style="color:#FFFFFF" >Home</a></span>  &nbsp; &raquo;&nbsp; 
                           ...
                           <span class="navclass"><a href="#" style="color:#FFFFFF"> Board Members</a></span>
                      </p>-->
					...
					<div class="content" style="padding-top:15px; text-align:justify">
                          ...
                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FF9900" style="border-spacing:10px">
        <tr>
    ...
    <tbody>
    <tr>
    <td width="85" style="vertical-align:top"><?php if(!empty($row_brd['image'])) { ?><img style="margin-right: 10px; max-width:100px;" src="<?php echo $base_url; ?>/tbdata/members/<?php echo $row_brd['image']; ?>" alt="" width="69" height="88" /> <?php } else {?><img style="margin-right: 10px; max-width:100px;" src="<?php echo $base_url; ?>/tbdata/members/boardmembers_thumb.gif" alt="" width="69" height="88" /><?php }?></td>
