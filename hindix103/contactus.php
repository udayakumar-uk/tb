...
$selcont=executework("select * from tob_cms where pageid=5");
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <?php
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td height="25" bgcolor="#e7e6e6"><div class="breadcrumb flat"> <a href="#" class="active">Home</a> <a href="#">About Us</a> <a href="#">Contact Us</a> </div>
        ...
        <td width="8%" bgcolor="#e7e6e6">
		   <?php
				...
				{
		   ?>
		   <a href="#" onclick="MM_openBrWindow('contactus.php?prin=y','','width=800,height=600')"><img src="tob2_imgs/printButton.gif" border="0" /></a> <a href="#" onclick="MM_openBrWindow('contactus.php?prin=y','','width=800,height=600')">Print</a>
		   <?php
		   		}
		   ?></td>
      </tr>
