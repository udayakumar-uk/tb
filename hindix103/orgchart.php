...
$selcont=executework("select * from tob_cms where pageid=4");
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="229" rowspan="2" valign="top" bgcolor="#ededed" >
	<?php include_once("leftmenu.php")
  ?>	</td>
    <td colspan="2" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#e7e6e6" class="tabbor">
      <tr>
        <td><div class="breadcrumb flat"> <a href="#" class="active">Home</a> <a href="#">About Us</a> <a href="#">Organisation Chart</a> </div>
