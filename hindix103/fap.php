...
$selcont=executework("select * from tob_cms where pageid=68");
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td width="92%" height="25" bgcolor="#e7e6e6"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td><div class="breadcrumb flat"> <a href="#" class="active">Home</a> <a href="#">Auction Produres </a> <a href="#">Facilities at Auction Platforms</a></div></td>
            </tr>
        </table></td>
        <td width="8%" bgcolor="#e7e6e6"><?php
				...
				{
		   ?>
            <a href="#" onclick="MM_openBrWindow('fap.php?prin=y','','width=800,height=600')"><img src="tob2_imgs/printButton.gif" border="0" /></a> <a href="#" onclick="MM_openBrWindow('fap.php?prin=y','','width=800,height=600')">Print</a>
            <?php
		   		}
		   ?>
        </td>
