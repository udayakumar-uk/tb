...
$selcont=executework("select * from tob_cms where pageid=18");
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td width="92%" height="25" bgcolor="#e7e6e6"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td><div class="breadcrumb flat"> <a href="#">Home</a> <a href="#">Forms</a></div>
        ...
        <td width="8%" bgcolor="#e7e6e6"><?php
				...
				{
		   ?>
            <a href="#" onclick="MM_openBrWindow('forms.php?prin=y','','width=800,height=600')"><img src="tob2_imgs/printButton.gif" border="0" /></a> <a href="#" onclick="MM_openBrWindow('forms.php?prin=y','','width=800,height=600')">Print</a>
            <?php
		   		}
		   ?>
        </td>
              ...
              <div>
                <div>
                  <div class="rightcorner1">
                        ...
                        <a href="javascript:window.print()" target="_blank"></a></div>
                </div>
                </div>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><table width="100%" border="0">
      <tr>
        <td width="47%">&nbsp;</td>
        <td width="33%"><a href="http://get.adobe.com/reader/" target="_blank"><img src="tob_imgs1/get_adobe_reader.png" width="158" height="35" border="0" /></a></td>
  ...
  <tr>
    ...
    <td width="725" valign="top"><img src="tob2_imgs/spacer.png" width="535" height="1" /></td>
    <td width="370" valign="top"><img src="tob2_imgs/spacer.png" width="225" height="1" /></td>
  </tr>
  <tr>
