...
$selcont=executework("select * from tob_cms where pageid=66");
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<a href="#">Auction Produres </a>
	<a href="#">Introduction</a></div>
        ...
        <td width="8%" bgcolor="#e7e6e6">
		   <?php
				...
				{
		   ?>
		   <a href="#" onclick="MM_openBrWindow('bactivities.php?prin=y','','width=800,height=600')"><img src="tob2_imgs/printButton.gif" border="0" /></a> <a href="#" onclick="MM_openBrWindow('aucintro.php?prin=y','','width=800,height=600')">Print</a>
		   <?php
		   		}
		   ?>
		   </td>
      ...
      <tr>
        <td height="30" align="justify"><div class="rightcorner1">
          <div class="innercontent"><?php echo $rowc['content'] ?>          </div>
