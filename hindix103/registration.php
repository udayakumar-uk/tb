...
$selcont=executework("select * from tob_cms where pageid=9 and isactive=1");
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="3" valign="top"><div id="head"><? include_once("header.php")
  ?></div></td>
  </tr>
  <tr>
  	<?
  ...
  <?
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td height="25" bgcolor="#F7F7F7">&nbsp;&nbsp;&nbsp; <a href="default.php">Home</a>&nbsp; &raquo;&nbsp; FCV Growers &nbsp; &raquo;&nbsp; Registration </td>
      <td width="8%" bgcolor="#F7F7F7">
		   <?
		   		if(empty($_GET[prin]))
				{
		   ?>
		   <a href="#" onclick="MM_openBrWindow('registration.php?prin=y','','width=800,height=600')"><img src="tob2_imgs/printButton.gif" border="0" /></a> <a href="#" onclick="MM_openBrWindow('registration.php?prin=y','','width=800,height=600')">Print</a>
		   <?
		   		}
		   ?>
		   </td>
