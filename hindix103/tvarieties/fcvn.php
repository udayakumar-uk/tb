...
$selcont=executework("select * from tob_cms where pageid=25");
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  ?>	</td>
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td height="25" bgcolor="#F7F7F7">&nbsp;&nbsp;&nbsp; <a href="default.php">Home</a>&nbsp; &raquo;&nbsp; FCV Tobacco &nbsp; &raquo;&nbsp; FCV (NLS) </td>
		<td width="8%" bgcolor="#F7F7F7">
		   <?
		   		if(empty($_GET[prin]))
				{
		   ?>
		   <a href="#" onclick="MM_openBrWindow('fcvn.php?prin=y','','width=800,height=600')"><img src="tob2_imgs/printButton.gif" border="0" /></a> <a href="#" onclick="MM_openBrWindow('fcvn.php?prin=y','','width=800,height=600')">Print</a>
		   <?
		   		}
		   ?>
		   </td>
