...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="3" valign="top"><div id="head"><?php include_once("headerx.php");?></div></td>
  </tr>
  <tr>
  	<?php
		if(empty($_GET['prin']))
	...
	<?php include_once("leftmenux.php")
  ?>	</td>
    <?php
		}
	?>
...
<script src="js/crumb.js" type="text/javascript"> </script>
        ...
        <td width="8%" bgcolor="#e7e6e6">
		   <?php
				...
				{
		   ?>
		   <a href="#" onclick="MM_openBrWindow('bactivities.php?prin=y','','width=800,height=600')"><img src="tob2_imgs/printButton.gif" border="0" /></a> <a href="#" onclick="MM_openBrWindow('bactivities.php?prin=y','','width=800,height=600')">&#2331;&#2366;&#2346;</a>
		   <?php
		   		}
		   ?>
		   </td>
