...
$selcont=executework("select * from tob_cms where pageid=40");
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  ?>	</td>
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td height="25" bgcolor="#F7F7F7">&nbsp;&nbsp;&nbsp; <a href="default.php">Home</a>&nbsp; &raquo;&nbsp; Auctions &nbsp; &raquo;&nbsp;Auction System </td>
      </tr>
    </table>
      <br />
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><table width="100%" border="0">
      <tr>
        <td width="47%">&nbsp;Page Updated on : <span class="update">11-07-2013</span> </td>
        <td width="33%">&nbsp;</td>
