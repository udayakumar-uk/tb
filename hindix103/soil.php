...
$selcont=executework("select * from tob_cms where pageid=31");
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  ?>	</td>
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td height="25" bgcolor="#F7F7F7">&nbsp;&nbsp;&nbsp; <a href="default.php">Home</a>&nbsp; &raquo;&nbsp;Services To FCV Farmers&nbsp; &raquo;&nbsp;Soil &amp; Water Analysis </td>
		<td width="8%" bgcolor="#F7F7F7">
		   <?php
		   		if(empty($_GET[prin]))
				{
		   ?>
		   <a href="#" onclick="MM_openBrWindow('soil.php?prin=y','','width=800,height=600')"><img src="tob2_imgs/printButton.gif" border="0" /></a> <a href="#" onclick="MM_openBrWindow('soil.php?prin=y','','width=800,height=600')">Print</a>
		   <?php
		   		}
		   ?>
	      </td>
      ...
      <tr>
        <td height="30" align="justify"><div class="rightcorner1">
          ...
          <div class="rightcorner1">
              <div class="innercontent">
                <div>
                  <div><a href="soil.php" title=""></a></div>
                  <div>
                    <div>
  ...
  <tr>
    ...
    <td width="535" valign="top"><img src="tob2_imgs/spacer.png" width="535" height="1" /></td>
    <td width="232" valign="top"><img src="tob2_imgs/spacer.png" width="225" height="1" /></td>
  </tr>
     <?php
  	}
  ?>
