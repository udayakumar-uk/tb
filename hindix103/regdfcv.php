...
//$selcont=executework("select * from tob_cms where pageid=69");
$selcont=executework("select * from tob_cms where pageid=72");
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  ?>	</td>
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td width="92%" height="25" bgcolor="#e7e6e6">
...
<div class="breadcrumb flat"> <a href="#" class="active">Home</a> <a href="#">Crop Planning and Regulation</a> <a href="#">License as Flue Cured Virginia Tobacco Grower</a></div>
        ...
        <td width="8%" bgcolor="#e7e6e6">
		   <?php
				...
				{
		   ?>
		   <a href="#" onclick="MM_openBrWindow('bactivities.php?prin=y','','width=800,height=600')"><img src="tob2_imgs/printButton.gif" border="0" /></a> <a href="#" onclick="MM_openBrWindow('criteria.php?prin=y','','width=800,height=600')">Print</a>
		   <?php
		   		}
		   ?>
		   </td>
      ...
      <tr>
        <td height="30" align="justify"><div class="rightcorner1">
          <div class="innercontent"><?php echo $rowc['hcontent'] ?>          </div>
  ...
  ?>
  <tr>
    <td valign="top" style="background-position:top left;">&nbsp;</td>
  ...
  <tr>
   <!-- <td valign="top"><img src="tob2_imgs/spacer.png" width="220" height="1" /></td>
    <td width="792" valign="top"><img src="tob2_imgs/spacer.png" width="535" height="1" /></td>
