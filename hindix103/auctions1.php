...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  ?>	</td>
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td height="25" bgcolor="#F7F7F7">&nbsp;&nbsp;<a href="index.php">&#2361;&#2379;&#2350;</a>
          &raquo; एफसीवी तम्बाकू नीलामी </td>
      </tr>
    </table>
      <br />
                    ...
                    <form id="actn" name="actn" method="post" action="">
                      <div> <br />
                          <table width="800" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#F0F0F0">
                            <tr bgcolor="#FFF0FF">
                              <td width="200" class="style38"><label><input type="radio" name="state" id="state" value="Andhra Pradesh" <?php echo $ap ?> onchange="subform();" />&nbsp;&nbsp;आंध्र प्रदेश </label></td>
                              <td width="232" class="style38"><label>
                              <input name="tp" type="radio" value="q" checked="checked" onchange="actn.submit();" />
                              </label>
दिन की जानकारी </td>
                              <td width="312" class="style38">तारीख :&nbsp;
<label>
...
&nbsp;&nbsp;कर्नाटक </label>                              </td>
                              ...
                              संचयी जानकारी </td>
                              <td align="center" class="style38"><a style="cursor:pointer" onclick="toggle_forms('auctions.php','actn');"  class="b">टेबल प्रारूप में देखें</a></td>
                              <?php
					if(!empty($_POST['yr']))
					$yrs=$_POST['yr'];
                                  ...
                                  <table width="180" border="0" cellpadding="2" cellspacing="2" bgcolor="#CCCCCC">
                                    ...
                                    <tr bgcolor="#FFFFFF">
                                      <td><label><input name="platform[]" type="checkbox" value="<?php echo $plat1[$i][0] ?>" <?php echo $chkk ?> id="platform[]" onchange="actn.submit();" />
                                        &nbsp;&nbsp;<?php echo $arr[$hid]; //echo $plat1[$i][1] ?></label></td>
                                    </tr>
									...
									?>
                                    <tr bgcolor="#FFFFFF">
                                      <td class="style38"><div align="center"><a style="cursor:pointer" onclick="checkAll('actn', 'true');"><strong>सभी की जांच करो</strong></a></div></td>
                                    </tr>
                                    <tr bgcolor="#FFFFFF">
                                      <td class="style38"><div align="center"><strong><a style="cursor:pointer" onclick="checkAll('actn','');">सब को अचयनित करें</a></strong></div></td>
                                    </tr>
                                  </table>
                                </div></td>
                              </tr>
...
//	alert("tot="+prca);
  ...
  var plot1 = $.jqplot ('chart2', tot, {
    ...
    //  title: 'Domestic Auction Information (Platform Wise)',
		title: 'घरेलू नीलामी जानकारी(मंच के अनुसार)',
              animate: true,
...
//							shadowAlpha: 0.07   // Opacity of the shadow
   ...
   function graph2(){
	...
	tit ="घरेलू नीलामी जानकारी(मंच के अनुसार)";

		var ylab='Cumulative Average Price';
		ylab="संचयी औसत मूल्य";
