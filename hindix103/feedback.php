...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  ?>
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td width="90%" height="25" bgcolor="#F7F7F7"><div class="breadcrumb flat"> <a href="index.php">&nbsp;Home</a>&nbsp;&nbsp; <a href="#">Feedback</a></div></td>
        <td width="10%" bgcolor="#F7F7F7">Print</td>
      </tr>
    </table>
      <br />
		<form id="form1" name="form1" method="post" action="feedback.php" onsubmit="return validation();">
      ...
      <tr>
		...
		?>
          ...
          <tr>
            <td><div align="left">  Organization Name</div></td>
            <td>
                <input name="org" type="text" id="org" />            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td><div align="left">Mobile/Telephone Number </div></td>
            <td>
                <input name="ph" type="text" id="ph" />            </td>
          </tr>
          <tr>
            <td><div align="left">Feedback</div></td>
            <td>
                <textarea name="fb" id="fb"></textarea>            </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>
		  ...
		  if(!empty($_POST['Submit']))
		  {
				...
				$strhtml1=$strhtml1."<tr><td >Feedback</td> <td >".$_POST['fb']."</td></tr>";
	...
	{
		redirect("feedback.php?succ=1");
	}
	else
	{
		redirect("feedback.php?succ=2");
	}
...
//echo $msg;
  ...
  <tr>
    <td colspan="2" valign="top"><table width="100%" border="0">
      <tr valign="middle">
        <td><div align="right"><a href="#top" ><img src="tob2_imgs/bact2top.jpg" width="94" height="27" border="0" title="Back to top" alt="Back to Top" /></a></div></td>
        </tr>
    </table></td>
  </tr>
  <tr>
