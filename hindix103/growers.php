...
$selcont=executework("select * from tob_cms where pageid=32");
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  ?>	</td>
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td height="25" bgcolor="#F7F7F7">&nbsp;&nbsp;&nbsp; <a href="default.php">Home</a>&nbsp; &raquo;&nbsp;Services To FCV Farmers&nbsp; &raquo;&nbsp;Growers Welfare Schemes </td>
