...
$selcont=executework("select * from tob_cms where pageid=30");
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  ?>	</td>
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td height="25" bgcolor="#F7F7F7">&nbsp;&nbsp;&nbsp; <a href="default.php">Home</a>&nbsp; &raquo;&nbsp; Services To FCV Farmers &nbsp; &raquo;&nbsp;Loans to Farmers </td>
		<td width="8%" bgcolor="#F7F7F7">
		   <?php
		   		if(empty($_GET[prin]))
				{
		   ?>
		   <a href="#" onclick="MM_openBrWindow('loans.php?prin=y','','width=800,height=600')"><img src="tob2_imgs/printButton.gif" border="0" /></a> <a href="#" onclick="MM_openBrWindow('loans.php?prin=y','','width=800,height=600')">Print</a>
		   <?php
		   		}
		   ?>
	      </td>
