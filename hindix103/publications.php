...
<title>publications &amp; Events | Tobacco Board, Guntur</title>
  ...
  ?>	</td>
   ...
   ?> 
	<td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
     <td height="25" bgcolor="#F7F7F7" ><div class="breadcrumb flat">        
  <a href="index.php">Home</a>
          <?php if(empty($_GET['ar'])) {?>
          <a href="#">Publications</a>
          <?php }else {?>
  <a href="publications.php">Publications</a> <a href="#">Archives</a>
<?php }?></div></td>
        <td width="10%" bgcolor="#F7F7F7"><?php
		   		if(empty($_GET['prin']))
				{
		   ?>
          <a href="#" onclick="MM_openBrWindow('publications.php?ar=<?php echo $_GET['ar']?>&amp;prin=y','','width=800,height=600')"><img src="tob2_imgs/printButton.gif" border="0" /></a> <a href="#" onclick="MM_openBrWindow('publications.php?ar=<?php echo $_GET['ar']?>&amp;prin=y','','width=800,height=600')">Print</a>
          <?php
		   		}
		   ?></td>
      </tr>
...
if ($count > 0)
{
	...
	?>
	  ...
	  for($im=1;$im<=$pages;$im++)
	  {
			...
			{
				?>
                                          <a href="publications.php?page_index=<?php echo "$im" ?>&amp;ar=<?php echo $_GET[ar]?>" class="hlink1"><?php echo "$im" ?></a>&nbsp;
                                          <?php
			}
			else
			{
	...
	?>
			...
			{
				if($rows['tfile']!="")
				$link="../tbdata/publicationsfiles/".$rows['tfile'];
				else
				$link="#";
        ...
        <td width="41%">
			<div align="center">
			  <?php
				...
				{
			?>
			  <a href="publications.php" class="a">&laquo; Back To Publications </a>
			  <?php
				}
				else
				{
			?>
			  <a href="publications.php?ar=1" class="a">&raquo; Archives</a>
			  <?php	
				}
			?>
	          </div></td>
  ...
  <tr>
    ...
    <td width="765" valign="top"><img src="tob2_imgs/spacer.png" width="535" height="1" /></td>
    <td width="327" valign="top"><img src="tob2_imgs/spacer.png" width="225" height="1" /></td>
  </tr>
	<?php
		}
	?>
