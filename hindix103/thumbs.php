    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:800px;height:456px;overflow:hidden;visibility:hidden;background-color:#24262e;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:800px;height:500px;overflow:hidden;">
							...
							$sel=executework("select * from tob_images where titleid='". $_GET['tit'] ."' order by position");
									...
									{
							$add="../tbdata/photogallery/oimages/$rows[image]";
								  ...
								  ?>
            <div>
                <img data-u="image" style="height:400px;" src="../tbdata/photogallery/oimages/<?php echo $rows['image']?>" />
                <img data-u="thumb" src="../tbdata/photogallery/thimages/<?php echo $rows['image']?>" />
            </div>
                                    <?php
									$i++;
									}				 
