...
$selcont=executework("select * from tob_cms where pageid=73");
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td width="92%" height="25" bgcolor="#e7e6e6"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td><div class="breadcrumb flat"> <a href="#" class="active">Home</a> <a href="#">Assistance To Exporters</a> <a href="#">Export Promotion Activities</a><a href="#">Incentives/Benefits</a> </div>
        ...
        <td width="8%" bgcolor="#e7e6e6"><?php
				...
				{
		   ?>
            <a href="#" onclick="MM_openBrWindow('<?php $_SERVER['PHP_SELF']; ?>?prin=y','','width=800,height=600')"><img src="tob2_imgs/printButton.gif" border="0" /></a> <a href="#" onclick="MM_openBrWindow('<?php $_SERVER['PHP_SELF']; ?>?prin=y','','width=800,height=600')">Print</a>
            <?php
		   		}
		   ?>
        </td>
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><table width="100%" border="0">
      <tr>
        <td width="47%">&nbsp;</td>
        <td width="33%"><a href="http://get.adobe.com/reader/" target="_blank"><img src="tob_imgs1/get_adobe_reader.png" width="158" height="39" border="0" /></a></td>
  ...
  <tr>
    ...
    <td width="827" valign="top"><img src="tob2_imgs/spacer.png" width="535" height="1" /></td>
