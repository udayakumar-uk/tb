...
if(empty($_SESSION['captcha_code'] ) || strcasecmp($_SESSION['captcha_code'], $_POST['captcha_code']) != 0){  
...

	{
		...
		$intst00=executework1("select * from auction_admin where admin='" . $_POST['userid'] . "' and password='" . $_POST['password'] . "'");
	...
	//	exit();
...

		{
			...
			$_SESSION['tob_type']='auction';
			$_SESSION['tob']='auction';

			//print_r($row00);

		

		$ins=executework("update auction_admin set previous_date ='".$row00['current_dt']."', current_dt='".date('Y-m-d H:i:s')."', ip_address ='".$_SERVER['REMOTE_ADDR']."' where admin ='".$_SESSION['tobadmin']."'");
