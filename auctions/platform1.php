...
<?php
	...
	if(!empty($_POST['subm']))
	{
		...
		if($cnt>0)
		{
			...
			$upqry=executework("update tob_auct set qauth=".$_POST['qauth'].",qest=".$_POST['qest'].",cdate='".datepattrn1($_POST['cdate'])."',edate='".datepattrn1($_POST['edate'])."' where id=".$row['id']);
		}
		else
		{
			$intqry=executework("insert into tob_auct values(".$max.",".$_POST['plats'].",".$_POST['year'].",".$_POST['qauth'].",".$_POST['qest'].",'".datepattrn1($_POST['cdate'])."','".datepattrn1($_POST['edate'])."')");
		}
