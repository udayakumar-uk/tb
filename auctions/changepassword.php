...
<?php
	...
	{
		echo ("select password from auction_admin where admin='".$_SESSION['tobadmin']."' and password='" .$_POST['oldpass'] . "'");
		//exit();
		$sql=executework("select password from auction_admin where admin='".$_SESSION['tobadmin']."' and password='" .$_POST['oldpass'] . "'");
		$count=@mysqli_num_rows($sql);
		if($count > 0)
		{
			$sq11=executework("update auction_admin set password='".$_POST['newpass']."' where admin='".$_SESSION['tobadmin']."'");
			$succ=1;
		}
		else
		{
