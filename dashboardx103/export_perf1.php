      ...
      <div class="row">
        <div class="col-lg-4" style="padding-left: 5px; padding-right: 5px;">
           ...
           <div class="card" >
		    ...
		    <h6 class="text-uppercase">PREVIOUS YEAR(QUANTITY)</h6>
              ...
              <div class="card-body" style="padding: 0.25em"> 
                ...
                <div class="tab-content">
                  <div id="piil-7" class="container tab-pane active" style="padding-left: 5px; padding-right: 5px;">
                     <!--<div id="chartContainer" style="height: 300px; width: 100%;"></div>
 </div>-->
					<!--<div><span>Moused Over: </span><span id="info1">Nothing</span></div>-->
    
    <div id="chart7" style="margin-top:0px; margin-left:0px; width:380px; height:300px;"></div>
		    ...
		    <h6 class="text-uppercase">PREVIOUS YEAR(QUANTITY)</h6>
              ...
              <div class="card-body" style="padding: 0.25em"> 
                ...
                <div class="tab-content">
                  ...
                  <div id="piil-8" class="container tab-pane active" style="padding-left: 5px; padding-right: 5px;">
				  
				
    
    <div id="chart8" style="margin-top:0px; margin-left:0px; width:380px; height:300px;"></div>
		    ...
		    <h6 class="text-uppercase">PREVIOUS YEAR(QUANTITY)</h6>
              ...
              <div class="card-body" style="padding: 0.25em"> 
                ...
                <div class="tab-content">
                  ...
                  <div id="piil-9" class="container tab-pane active" style="padding-left: 5px; padding-right: 5px;">
				  
				
    
    <div id="chart9" style="margin-top:0px; margin-left:0px; width:380px; height:300px;"></div>
<pre class="code brush:js"></pre>     </div>
      ...
      <div class="row">
        <div class="col-lg-4" style="padding-left: 5px; padding-right: 5px;">
           ...
           <div class="card" >
		    ...
		    <h6 class="text-uppercase">PREVIOUS YEAR(VALUE)</h6>
              ...
              <div class="card-body" style="padding: 0.25em"> 
                ...
                <!-- Tab panes -->
                <div class="tab-content">
                  <div id="piil-10" class="container tab-pane active" style="padding-left: 5px; padding-right: 5px;">
                     <!--<div id="chartContainer" style="height: 300px; width: 100%;"></div>
 </div>-->
					<!--<div><span>Moused Over: </span><span id="info1">Nothing</span></div>-->
    
    <div id="chart10" style="margin-top:0px; margin-left:0px; width:380px; height:300px;"></div>
<pre class="code brush:js"></pre> 
					</div>
		    ...
		    <h6 class="text-uppercase">PREVIOUS YEAR(VALUE)</h6>
              ...
              <div class="card-body" style="padding: 0.25em"> 
                ...
                <div class="tab-content">
                  ...
                  <div id="piil-11" class="container tab-pane active" style="padding-left: 5px; padding-right: 5px;">
				  
				
    
    <div id="chart11" style="margin-top:0px; margin-left:0px; width:380px; height:300px;"></div>
<pre class="code brush:js"></pre>     </div>
		    ...
		    <h6 class="text-uppercase">PREVIOUS YEAR(VALUE)</h6>
              ...
              <div class="card-body" style="padding: 0.25em"> 
                ...
                <div class="tab-content">
                  ...
                  <div id="piil-12" class="container tab-pane active" style="padding-left: 5px; padding-right: 5px;">
				  
				
    
    <div id="chart12" style="margin-top:0px; margin-left:0px; width:380px; height:300px;"></div>
<pre class="code brush:js"></pre>     </div>
       ...
       <div class="row">
         ...
         <div class="col-lg-2" style="padding-left: 5px; padding-right: 5px;">
           ...
           <a href="export_perf.php"><div class="card">
		  
		   
		    <h6 class="text-uppercase" style="background-color: #1e4c1b">CURRENT YEAR</h6>
