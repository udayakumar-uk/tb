...
color:#0c6f0c;font-size:30px;"><a href="index.php">E-AUCTIONS - KARNATAKA</a></h4>
      ...
      <div class="row">
        <div class="col-lg-12">
           ...
           <div class="card">
		    ...
		    <h6 class="text-uppercase">FCV TOBACCO AUCTIONS DAY INFORMATION (KARNATAKA)</h6>
                          ...
                          <div class="example-content">
                            ...
                            <div id="chart2" style="margin-top:20px; margin-left:20px; width:900px; height:500px;" align="center"></div></div></td>
                                <td valign="top"><div align="center">
                                  <table width="180" border="0" cellpadding="2" cellspacing="2" bgcolor="#FFF0FF">
                                        <?php
									...
									?>
                                    <tr bgcolor="#FFFFFF">
                                      <td bgcolor="#FFF0FF"><label><input name="platform[]" type="checkbox" value="<?php echo $plat1[$i][0] ?>" <?php echo $chkk ?> id="platform[]" onchange="actn.submit();" />
...
$sel1=executework("select * from tob_auction,tob_platform where tob_auction.platf=tob_platform.id and state='".$stat."' and tdate='".$adate."' and tob_platform.isactive=1 order by field(tob_platform.catg,'NBS','SBS','SLS','NLS'),tob_platform.seqid");
        ...
        <div class="col-lg-12">
           ...
           <div class="card">
		    ...
		    <h6 class="text-uppercase">FCV TOBACCO AUCTIONS CUMULATIVE INFORMATION (KARNATAKA)</h6>
...
$sel1=executework("select * from tob_auction,tob_platform where tob_auction.platf=tob_platform.id and state='".$stat."' and tdate='".$adate."' and tob_platform.isactive=1 order by field(tob_platform.catg,'NBS','SBS','SLS','NLS'),tob_platform.seqid");
 ...
 <div class="row">
         ...
         <div class="col-lg-2" style="padding-left: 5px; padding-right: 5px;">
           ...
           <a href="auctions1.php"><div class="card">
		  
		   
		    <h6 class="text-uppercase" style="background-color: #1e4c1b">VIEW ANDHRAPRADESH</h6>
