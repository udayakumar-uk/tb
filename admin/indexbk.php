...
if(empty($_SESSION['captcha_code'] ) || strcasecmp($_SESSION['captcha_code'], $_POST['captcha_code']) != 0){  
...

	{
		...
		$intst00=executework1("select * from tob_admin where admin='" . $_POST['userid'] . "' and password='" . $_POST['password'] . "'");

		//$intst00=executework("select * from tob_admin");

		//echo ("select * from tob_admin");
	...
	//	exit();
...

		{
			...
			$intst000=executework1("select * from tob_employeeview where username ='".$_POST['userid']."' and password ='".$_POST['password']."' and disable=0");

			$countst000=@mysqli_num_rows($intst000);

			$rowt=@mysqli_fetch_array($intst000);

			if($rowt['permissions']=='VIEW,PRINT' || $rowt['permissions']=='PRINT,VIEW')
...
//// echo "Submit";
//
//	//executeupdate("insert into jun_admin values('','".$_POST['username']."','".md5($_POST['password'])."')");
//
//	if(empty($_SESSION['captcha_code'] ) || strcasecmp($_SESSION['captcha_code'], $_POST['captcha_code']) != 0)
//
//	{  
