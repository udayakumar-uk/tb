...
<title>Post Employee Corner | Welcome To TOBBACO BOARD Admin</title>
<style type="text/css">
<!--
.style1 {
...
?>
  <table width="90%" border="0" align="center">
    ...
    <tr>
      <td colspan="3"><span class="style1">Post Employee Corner </span> </td>
    </tr>
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">New Details Posted Successfully</span> </td>
    </tr>
	<?php
		}
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">Selected Deltails Successfully Move To Archives</span> </td>
    </tr>
	<?php
		}
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">Selected Details Modify Successfully</span> </td>
    </tr>
	<?php
		}
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">Selected  Details Deleted Successfully</span> </td>
    </tr>
	<?php
		}
		else
	...
	?>
    <tr>
      <td height="30" style="padding-left:35px;"><span class="style4">Order Type </span></td>
...
-->      </select>
    ...
    <tr>
      <td height="30" style="padding-left:35px;"><span class="style4">Order Details </span></td>
      <td><div align="center"><strong>:</strong></div></td>
      <td><label>
        <input name="order_details" type="text" id="order_details" value="<?php echo $trow['order_details']?>" size="53" />
      </label></td>
    </tr>
    <tr>
      <td height="30" style="padding-left:35px;"><span class="style4">Hindi Order Details </span></td>
      <td><div align="center"><strong>:</strong></div></td>
      <td><label>
      <textarea name="horder_details" id="horder_details" rows="3" cols="40"><?php echo $trow['horder_details']?></textarea>
       <!-- <input name="horder_details" type="text" id="horder_details" value="<?php //echo $trow['horder_details']?>" size="53" />-->
      </label></td>
    </tr>
    ...
    <tr>
      <td height="30" style="padding-left:35px;"><span class="style4">Status</span></td>
      <td height="30"><div align="center"><strong>:</strong></div></td>
      <td height="30"><label>
        <input name="order_status" type="text" id="order_status" />
      </label></td>
    </tr>
    <tr>
...
if ($count > 0)
{
	...
	?>
	  ...
	  for($im=1;$im<=$pages;$im++)
	  {
			...
			{
				?>
                                <a href="employee_corner.php?page_index=<?php echo "$im" ?>" class="hlink1"><?php echo "$im" ?></a>&nbsp;
                                <?php
			}
			else
			{
	...
	?>
              ...
              <tr>
                <td><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      ...
                      <td width="158" bgcolor="#FFFFFF"><div align="center"><span class="style8">Order Type  </span></div></td>
                      <td width="280" bgcolor="#FFFFFF"><div align="center" class="style8">Order Details </div></td>
                      <td width="280" bgcolor="#FFFFFF"><div align="center" class="style8">Hindi Order Details </div></td>
                      <td width="102" bgcolor="#FFFFFF"><div align="center"><span class="style8">Order Status </span></div></td>
		...
		?>
                    <tr>
                      ...
                      <td bgcolor="#FFFFFF" class="style17" style="padding-left:15px;"><a href="<?php echo $link;?>" target="<?php if($link!="#"){?>_blank<?php }?>" class="b"><?php echo $row['order_type']?></a></div></td>
                      <td bgcolor="#FFFFFF" class="style17" style="padding-left:15px; padding-right:15px;"><div align="justify"><?php echo $row['order_details']?></div></td>
                      <td bgcolor="#FFFFFF" class="style17" style="padding-left:15px; padding-right:15px;"><div align="justify"><?php echo $row['horder_details']?></div></td>
    ...
    if ($pages > 1)
  	{
		...
		if($page_index != 1)
		{
			...
			?>
                      <input name="button" type="button"  class="fbutton" onclick="location.href='employee_corner.php?page_index=<?php echo "$pre" ?>'" value="Previous" />
                    &nbsp;
                    <?php
		}
		if($page_index < $pages)
   		{
   			$next=$page_index+1;			
			?>
                    <input name="button" type="button"  class="fbutton" onclick="location.href='employee_corner.php?page_index=<?php echo "$next" ?>'" value="  Next  " />
                    <?php
