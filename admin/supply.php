...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  ?>	</td>
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabbor">
      <tr>
        <td height="25" bgcolor="#F7F7F7">&nbsp;&nbsp;&nbsp; <a href="default.php">Home</a>&nbsp; &raquo;&nbsp; Supply Of FCV Farmers &nbsp; &raquo;&nbsp;Supply Of Input </td>
		<td width="8%" bgcolor="#F7F7F7">
		   <?php
		   		if(empty($_GET[prin]))
				{
		   ?>
		   <a href="#" onclick="MM_openBrWindow('supply.php?prin=y','','width=800,height=600')"><img src="tob2_imgs/printButton.gif" border="0" /></a> <a href="#" onclick="MM_openBrWindow('supply.php?prin=y','','width=800,height=600')">Print</a>
		   <?php
		   		}
		   ?>
		   </td>
           ...
           <div class="innercontent">
            <div id="innermenu" class="innermenbox">
              <table width="100%" border="0" align="center" cellpadding="7" cellspacing="2" bgcolor="#F7F7F7">
                <tr>
                  <td width="93%" height="25" bgcolor="#F0E284"> &nbsp;&nbsp; <img align="absmiddle"  src="tob2_imgs/dtarrow.png" width="10" height="10" />&nbsp; <a href="supply.php">Supply Of Input </a></td>
                </tr>
                <tr>
                  <td height="25" bgcolor="#F0E284">&nbsp;&nbsp; <img align="absmiddle"  src="tob2_imgs/dtarrow.png" width="10" height="10" />&nbsp; <a href="loans.php">Loans To Farmers </a></td>
                </tr>
                <tr>
                  <td height="25" bgcolor="#F0E284">&nbsp;&nbsp; <img align="absmiddle"  src="tob2_imgs/dtarrow.png" width="10" height="10" />&nbsp; <a href="soil.php">Soil &amp; Water Analysis  </a></td>
                </tr>
                <tr>
                  <td height="25" bgcolor="#F0E284">&nbsp;&nbsp; <img align="absmiddle"  src="tob2_imgs/dtarrow.png" width="10" height="10" />&nbsp; <a href="growers.php">Growers Welfare Schemes </a></td>
                </tr>
                <tr>
                  <td height="25" bgcolor="#F0E284">&nbsp;&nbsp; <img align="absmiddle"  src="tob2_imgs/dtarrow.png" width="10" height="10" />&nbsp; <a href="weather.php">Weather </a></td>
                </tr>
