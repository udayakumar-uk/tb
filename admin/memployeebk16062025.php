...
if(!empty($_POST['subm']))
{
	...
	for($i=1;$i<=$_POST['pn'];$i++)
	{
		if(!empty($_POST['pid'.$i]))
		{
			...
			$upd=executework("update promotion_det set E_DES='".addslashes($_POST['E_DES'.$i])."',E_DOP_DT='".date('Y-m-d',strtotime($_POST['E_DOP_DT'.$i]))."',ptype='".addslashes($_POST['ptype'.$i])."',orderno='".addslashes($_POST['order'.$i])."' where id=".$_POST['pid'.$i]);
		}
		else
		{
			if(!empty($_POST['E_DES'.$i]))
			{
				$int=executework("insert into promotion_det values('".$maxid1."','".$eid."','".addslashes($_POST['E_DES'.$i])."','".date('Y-m-d',strtotime($_POST['E_DOP_DT'.$i]))."','".addslashes($_POST['ptype'.$i])."','".addslashes($_POST['order'.$i])."')");
				$maxid1++;
			}
		}
	}
                      ...
                      <tr>
                        <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="4" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#000000">
                          ...
                          <tr bgcolor="#F5F5F5">
                            ...
                            <td class="style8"><label>
                              <input name="Working_from" type="text" id="Working_from" value="<?php echo $working_from; ?>" />
                              </label></td>
                              <?php
							  	$dates1="Working_from";
							  ?>
                      ...
                      <tr>
                        <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="4" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#000000">
                            <tr bgcolor="#F5F5F5">
                              ...
                              <td width="29%" bgcolor="#F5F5F5" class="style8"><label>
                                <input name="E_DOB" type="text" id="E_DOB" value="<?php echo $e_dob; ?>" />
                                </label></td>
                                <?php
								$dates1.=",E_DOB";
								?>
                            ...
                            <tr bgcolor="#DDDDDD">
                              ...
                              <td bgcolor="#DDDDDD" class="style8"><label>
                                <input name="E_DOJ" type="text" id="E_DOJ" value="<?php echo $e_doj; ?>" />
                                <?php
								$dates1.=",E_DOJ";
								?>
                                </label></td>
                            ...
                            <tr bgcolor="#DDDDDD">
                              ...
                              <td bgcolor="#DDDDDD" class="style8"><label>
                                <input name="E_DOR" type="text" id="E_DOR" value="<?php echo $e_dor; ?>" />
                                <?php
								$dates1.=",E_DOR";
								?>
                                </label></td>
...
//								echo "<br>dd=".$fd."--".$td."--".$fdt."--".$tdt."       ".$diff;
						...
						?>
                          <tr bgcolor="<?php echo $bg ?>">
                            ...
                            <td><div align="center"><?php //echo datepattrn($rows['E_FROM']); ?>
                              <label>
                              <input name="E_FROM<?php echo $s ?>" type="text" id="E_FROM<?php echo $s ?>" value="<?php echo $e_from; ?>" />
                              </label>
                            </div></td>
                            <td><div align="center"><?php //echo datepattrn( substr($td,0,10)); ?>
                              <label>
                              <input name="E_TO<?php echo $s ?>" type="text" id="E_TO<?php echo $s ?>" value="<?php echo $e_to; ?>" />
                              </label>
                                <?php
								$dates1.=",E_FROM".$s.",E_TO".$s;
								?>
                            </div></td>
                            <td><div align="center"><?php if($days!='invalid') echo $days[0]."-".$days[1]."-".$days[2]; ?></div></td>
                        ...
                        <tr bgcolor="<?php echo $bg ?>">
                            ...
                            <td><div align="center"><?php //echo datepattrn($rows['E_FROM']); ?>
                              <label>
                              <input name="E_FROM<?php echo $s ?>" type="text" id="E_FROM<?php echo $s ?>" value="<?php if(!empty($_POST['E_FROM'.$s])) echo $_POST['E_FROM'.$s]; ?>" />
                              </label>
                            </div></td>
                            <td><div align="center"><?php //echo datepattrn( substr($td,0,10)); ?>
                              <label>
                              <input name="E_TO<?php echo $s ?>" type="text" id="E_TO<?php echo $s ?>" value="<?php if(!empty($_POST['E_TO'.$s])) echo $_POST['E_TO'.$s]; ?>" />
                              </label>
                                <?php
								$dates1.=",E_FROM".$s.",E_TO".$s;
								?>
...
//								{
						...
						?>
                          <tr bgcolor="<?php echo $bg ?>">
                            ...
                            <td><div align="center">
                              <label>
                              <input type="text" name="E_DOP_DT<?php echo $p ?>" id="E_DOP_DT<?php echo $p ?>" value="<?php echo $edt; ?>" />
                              </label>
                            </div></td>
							   <?php
								$dates1.=",E_DOP_DT".$p;
...
//						}
				 ...
				 ?>
                        <tr bgcolor="<?php echo $bg ?>">
                            ...
                            <td><div align="center">
                              <label>
                              <input type="text" name="E_DOP_DT<?php echo $p ?>" id="E_DOP_DT<?php echo $p ?>" value="<?php if(!empty($_POST['E_DOP_DT'.$p])) echo $_POST['E_DOP_DT'.$p]; ?>" />
                              </label>
                            </div></td>
							   <?php
								$dates1.=",E_DOP_DT".$p;
				   ...
				   if($cntl>0)
				   {
						...
						?>
                            <tr bgcolor="<?php echo $bg ?>">
                              ...
                              <td bgcolor="#DDDDDD" class="style8"><input name="edate<?php echo $l ?>" type="text" id="edate<?php echo $l ?>" value="<?php echo $edate; ?>" /></td>
...
//						}
				 ...
				 ?>
                            <tr bgcolor="<?php echo $bg ?>">
                              <td><?php echo $l ?></td>
                              <td><input name="edate<?php echo $l ?>" type="text" id="edate<?php echo $l ?>" value="<?php if(!empty($_POST['edate'.$l])) echo $_POST['edate'.$l] ?>" /></td>
