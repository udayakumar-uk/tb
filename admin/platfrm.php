...
?>
  ...
  ?>
	...
	?>
    <tr>
      <td colspan="3" class="style20"><div align="center">Given Platform Already Exists </div></td>
    </tr>
	  <?php
	  }
...
-->      </label></td>
    ...
    <tr>
      ...
      <td class="style8"><div align="center">:</div></td>
      <td><label>
        <input name="platform_name" type="text" id="platform_name" value="<?php if(!empty($rowy['platform'])) echo $rowy['platform']?>" />
      </label></td>
    </tr>
    <tr>
      ...
      <td class="style8"><div align="center">:</div></td>
      <td><label>
        <input name="apf" type="text" id="apf" value="<?php if(!empty($rowy['apfno'])) echo $rowy['apfno']?>" />
      </label></td>
    </tr>
	<?php
  ...
  <table width="100%" border="1" cellspacing="1" cellpadding="1">
    ...
    <tr class="style17">
      ...
      <td><?php echo $stat; ?></td>
      <td><label>
        <input type="button" name="Submit3" value="Modify" onclick="mod_master('<?php echo $rowth['id'] ?>')"/>
      </label></td>
      <td><label>
        <input type="button" name="Submit4" value="Delete" onclick="del_master('<?php echo $rowth['id'] ?>')" />
      </label></td>
    </tr>
	<?php
	$i++;
