...
<title>Post publications &amp; Events | Welcome To TOBBACO BOARD Admin</title>
<style type="text/css">
<!--
.style1 {
...
?>
  <table width="90%" border="0" align="center">
    ...
    <tr>
      <td colspan="3"><span class="style1">Post publications </span> </td>
    </tr>
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">Publications Posted Successfully</span> </td>
    </tr>
	<?php
		}
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">Selected publications Successfully Move To Archives</span> </td>
    </tr>
	<?php
		}
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">Selected publications Details Modify Successfully</span> </td>
    </tr>
	<?php
		}
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">Selected publications Details Deleted Successfully</span> </td>
    </tr>
	<?php
		}
		else
    ...
    <tr>
      <td height="30" valign="top" style="padding-left:35px;"><span class="style4">Description of publications</span></td>
    ...
    <tr>
      <td height="30" valign="top" style="padding-left:35px;"><span class="style4">Description of publications (Hindi) </span></td>
      <td height="30" valign="top"><div align="center"><strong>:</strong></div></td>
      <td height="30"><label>
    ...
    <tr>
      ...
      <td height="30" class="style8">
	  	<?php if(!empty($trow['tfile'])){?><a href="../tbdata/publicationsfiles/<?php echo $trow['tfile']?>" target="_blank">View File</a><br /><?php }?>
        <input name="tfile" type="file" id="tfile" />
        <input name="home" type="checkbox" id="home" value="1" <?php echo $home;?>/>
        Home</td>
    </tr>
    <tr>
      <td height="30" valign="top" class="style4" style="padding-left:35px;">Upload  Image </td>
      <td height="30" valign="top"><div align="center"><strong>:</strong></div></td>
      <td height="30" class="style8">
          <input name="img" type="file" id="img" /><?php if(!empty($trow['img'])){?><img src="../tbdata/publicationimgs/<?php echo $trow['img']?>" height="50" border="0" /><?php }?></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      ?>
                    <table width="80%" align="center" cellpadding="0" cellspacing="4">
                      <tr>
                        <td colspan="4"><div align="center" class="style53"><font color="#0000FF" size="3" face="Arial, Helvetica, sans-serif"><strong><font color="#0000BF">Total publications  - <?php echo $count ?></font></strong></font> </div></td>
                      </tr>
                      <?php
if ($count > 0)
{
	...
	?>
	  ...
	  for($im=1;$im<=$pages;$im++)
	  {
			...
			{
				?>
                                <a href="publications.php?page_index=<?php echo "$im" ?>" class="hlink1"><?php echo "$im" ?></a>&nbsp;
                                <?php
			}
			else
			{
              ...
              <tr>
                <td><table width="85%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      ...
                      <td width="261" bgcolor="#FFFFFF"><div align="center" class="style8">Publications Descripotion</div></td>
    ...
    if ($pages > 1)
  	{
		...
		if($page_index != 1)
		{
			...
			?>
                      <input name="button" type="button"  class="fbutton" onclick="location.href='publications.php?page_index=<?php echo "$pre" ?>'" value="Previous" />
                    &nbsp;
                    <?php
		}
		if($page_index < $pages)
   		{
   			$next=$page_index+1;			
			?>
                    <input name="button" type="button"  class="fbutton" onclick="location.href='publications.php?page_index=<?php echo "$next" ?>'" value="  Next  " />
                    <?php
