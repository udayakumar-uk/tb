...
?>
  <table width="90%" border="0" align="center">
    ...
    <tr>
      <td colspan="3"><span class="style1">Post Latest News</span> </td>
    </tr>
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">Latest News Posted Successfully</span> </td>
    </tr>
	<?php
		}
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">Selected Latest News Successfully Move To Archives</span> </td>
    </tr>
	<?php
		}
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">Selected Latest News Details Modify Successfully</span> </td>
    </tr>
	<?php
		}
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">Selected Latest News Details Deleted Successfully</span> </td>
    </tr>
	<?php
		}
		else
    ...
    <tr>
      <td height="30" valign="top" style="padding-left:35px;"><span class="style4">Latest Newsn Title </span></td>
    ...
    <tr>
      <td height="30" valign="top" style="padding-left:35px;"><span class="style4">Latest Newsn Title <br />
      (hindi) </span></td>
      <td height="30" valign="top"><div align="center"><strong>:</strong></div></td>
      <td height="30"><label>
    ...
    <tr>
      ...
      <td height="30" valign="top"><div align="center"><strong>:</strong></div></td>
      <td height="30" class="style8"><?php if(!empty($trow['tfile'])){?>
          <a href="../tbdata/latest/<?php echo $trow['tfile']?>" target="_blank">View File</a><br />
        <?php }?>
...
if ($count > 0)
{
	...
	?>
	  ...
	  for($im=1;$im<=$pages;$im++)
	  {
			...
			{
				?>
                                <a href="latest.php?page_index=<?php echo "$im" ?>" class="hlink1"><?php echo "$im" ?></a>&nbsp;
                                <?php
			}
			else
			{
    ...
    if ($pages > 1)
  	{
		...
		if($page_index != 1)
		{
			...
			?>
                      <input name="button" type="button"  class="fbutton" onclick="location.href='latest.php?page_index=<?php echo "$pre" ?>'" value="Previous" />
                    &nbsp;
                    <?php
		}
		if($page_index < $pages)
   		{
   			$next=$page_index+1;			
			?>
                    <input name="button" type="button"  class="fbutton" onclick="location.href='latest.php?page_index=<?php echo "$next" ?>'" value="  Next  " />
                    <?php
