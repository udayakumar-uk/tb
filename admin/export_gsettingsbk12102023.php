...
?>
  ...
  <table width="800" align="center" cellpadding="0" cellspacing="0">
	...
	?>
    <tr>
      <td width="239" height="30" class="style1">Export Graph</td>
      <td width="56">&nbsp;</td>
      <td width="503">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td height="30" class="style12"><div align="left" class="style8">Months Range</div></td>
      <td class="style12">&nbsp;</td>
  ...
  array("December",12)
    ...
    <tr>
      <td height="30" class="style12"><div align="left" class="style8">Category</div></td>
      ...
      <td class="">
        ...
        <?php
			if(!empty($row['export_category']))
			{
		?>
        <script type="text/javascript">
		$('#category').val('<?php echo $row['export_category']; ?>');
		</script>
        <?php
			}
		?>
    ...
    <tr>
      <td height="30" class="style12"><div align="left" class="style8">Type</div></td>
       <td class="style12a"><div align="center"><strong>:</strong></div></td>
      <td class="">
      	<input type="radio" name="export_type" id="export_type" value="quantity" <?php if($row['export_type']=="quantity" || $row['export_type']==""){ ?>checked="checked"<?php } ?>>&nbsp;Quantity
        <input type="radio" name="export_type" id="export_type" value="value" <?php if($row['export_type']=="value"){ ?>checked="checked"<?php } ?>>&nbsp;Value
      </td>
    </tr>
    <tr>
      <td colspan="3">&nbsp;</td>
