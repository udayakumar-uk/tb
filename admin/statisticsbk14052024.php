...
<title>Post Statistics | Welcome To TOBBACO BOARD Admin</title>
<style type="text/css">
<!--
.style1 {
...
$id='';
	...
	else if(!empty($_POST['subm']))
	{
		...
		$tselect=executework("select * from tob_statistics where tenderno='". $_POST['tenderno']."'");
		$tcnt=@mysqli_num_rows($tselect);
		if($tcnt>0)
		{
			redirect("statistics.php?exist=1");
		}
		else
		{
...
?>
  <table width="90%" border="0" align="center">
    ...
    <tr>
      <td colspan="3"><span class="style1">Post Statistics </span> </td>
    </tr>
	...
	?>
    <tr>
      <td height="40" colspan="3" class="style7" style="padding-left:150px;">Given Statistics Details Alredy Exist </td>
    </tr>
	<?php
		}
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">New Statistics Posted Successfully</span> </td>
    </tr>
	<?php
		}
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">Selected Statistics Details Modify Successfully</span> </td>
    </tr>
	<?php
		}
	...
	?>
    <tr>
      <td height="40" colspan="3" style="padding-left:150px;"><span class="style7">Selected Statistics Details Deleted Successfully</span> </td>
    </tr>
	<?php
		}
		else
	...
	?>
    <tr>
      <td height="30" style="padding-left:35px;"><span class="style4">Statistics Type  </span></td>
    ...
    <tr>
      <td height="30" valign="top" style="padding-left:35px;"><span class="style4">Description (Hindi) </span></td>
      <td height="30" valign="top"><div align="center"><strong>:</strong></div></td>
      <td height="30"><label>
    ...
    <tr>
      ...
      <td height="30" class="style8">
	  	<?php if(!empty($trow['tfile'])){?><a href="statisticsfiles/<?php echo $trow['tfile']?>" target="_blank">View File</a><br /><?php }?>
...
if ($count > 0)
{
	...
	?>
	  ...
	  for($im=1;$im<=$pages;$im++)
	  {
			...
			{
				?>
                                <a href="statistics.php?page_index=<?php echo "$im" ?>" class="hlink1"><?php echo "$im" ?></a>&nbsp;
                                <?php
			}
			else
			{
	...
	?>
              ...
              <tr>
                <td><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      ...
                      <td width="158" bgcolor="#FFFFFF"><div align="center"><span class="style8">Statistic Type </span></div></td>
		...
		?>
                    <tr>
                      ...
                      <td bgcolor="#FFFFFF" class="style17" style="padding-left:15px; padding-right:15px;"><a href="<?php echo $link;?>" target="<?php if($link!="#"){?>_blank<?php }?>" class="b"><div align="justify"><?php echo $row['description']?></div></a></td>
                      <td bgcolor="#FFFFFF" class="style17" style="padding-left:15px;"><?php echo $row['stype']?>
                          </div></td>
    ...
    if ($pages > 1)
  	{
		...
		if($page_index != 1)
		{
			...
			?>
                      <input name="button" type="button"  class="fbutton" onclick="location.href='statistics.php?page_index=<?php echo "$pre" ?>'" value="Previous" />
                    &nbsp;
                    <?php
		}
		if($page_index < $pages)
   		{
   			$next=$page_index+1;			
			?>
                    <input name="button" type="button"  class="fbutton" onclick="location.href='statistics.php?page_index=<?php echo "$next" ?>'" value="  Next  " />
                    <?php
