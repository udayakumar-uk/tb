...
if(!empty($_FILES['image']['name']))
{
	...
	echo "cnt=".$count=@mysqli_num_rows($sel);
	if($count>0)
	{
		...
		echo "update master_employee set image='".$f1."' where Employee_number='".$rowmd['Employee_number']."'";
...
//			}
		...
		redirect("employeedata.php?mid=1");
//	redirect("memployee.php?esucc=1&eid=".$eid);
}
?>
