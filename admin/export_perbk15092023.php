...
$id='';
	...
	if(!empty($_GET['edit']))
	{
		...
		else
		{
			if(!empty($_POST['subm']))
			{
					$tinsert=executework("update tob_export set quantity=".make_safe($_POST['qty']) .",value=". make_safe($_POST['val']) ." where id=".$id);
...
if ($count > 0)
{
	...
	?>
              ...
              <tr>
                <td><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      ...
                      <td width="173" bgcolor="#FFFFFF"><div align="center" class="style8">Value</div></td>
			...
			while($row=@mysqli_fetch_array($select1))
			{
				...
				$link="#";
				$mn=$month_name = date( 'F', mktime(0, 0, 0, $row['month']) );
		?>
                    <tr>
