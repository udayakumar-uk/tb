		...
		else
		{
			if(!empty($_POST['subm']))
			{
				...
				if (!empty($_FILES[$pimage]['name']))
				{
					...
					$tinsert=executework("update tob_circulars set title='". $_POST['title'] ."',htitle='". $_POST['htitle'] ."',description='". $_POST['description'] ."',hdescription='". $_POST['hdescription'] ."'$f2 where id=".$id);
