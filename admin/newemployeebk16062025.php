				   ...
				   if($cntl>0)
				   {
						...
						?>
                            <tr bgcolor="<?php echo $bg ?>">
                              ...
                              <td><input name="edate<?php echo $l ?>" type="text" id="edate<?php echo $l ?>" value="<?php echo $edate; ?>" /></td>
