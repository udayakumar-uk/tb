	...
	<div class="container-fluid">
		<div class="d-flex justify-content-end align-items-center gap-2 flex-wrap">
			...
			<div class="d-flex align-items-center">
				...
				<button class="btn btn-sm fw-bold lh-sm fs-6" id="incFont" title="Increase font" aria-label="Increase font"><span class="material-symbols-rounded notranslate">text_increase</span></button>
			</div>
			<!-- <button class="btn btn-sm" title="Toggle Contrast" aria-label="Toggle Contrast"> -->
				<label for="theme" class="btn btn-sm" title="Toggle Contrast" aria-label="Toggle Contrast">
					<span class="material-symbols-rounded notranslate">contrast</span>
