			...
			<div class="main-content col11">
				...
				<div class="rslides_container">
					<ul class="rslides" id="slider" style="padding-left:0px; max-width:100%">
						...
						<li  style="padding-left:0px"><img src="images/edscroll.jpeg"/></li>
						<!-- <li  style="padding-left:0px"><img src="images/b33.jpg"/></li>  -->
						<li  style="padding-left:0px"><img src="images/164board.JPG"/></li>
...
<!--<img src="images/v1.jpg"/>-->	
		...
		<section class="col-1-3" style="width:22%">
                ...
                <img src="<?php echo $base_url; ?>/tbdata/members/newChairman1.jpg" style="width:auto; height:150px; margin:5px;" align="middle"><br>
            ...
            <section class="col-1-3" style="width:22%">
                ...
                <img src="<?php echo $base_url; ?>/images/ednew1.jpg" style="width:auto; height:150px; margin:5px;" align="middle"><br>

             		<strong>  Ms.Vishwasree B, IAS</strong><br>  <br> 
